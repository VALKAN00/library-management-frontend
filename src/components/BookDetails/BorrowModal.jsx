          ...
          {!showSuccess ? (
            <>
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex-1 px-6 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-colors shadow-lg"
                >
            ...
            <>
              ...
              <p className="text-gray-400 text-center mb-8 leading-relaxed">
                You have successfully borrowed "{book.Title}". Please pick it up from the main desk within 3 days. Your due date is {formattedDueDate}.
              </p>
